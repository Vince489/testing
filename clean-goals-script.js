...
- goals_training_pairs.json: CBOW training pairs [context, target]
...
3. TRAINING PAIR GENERATION:
   - Used CBOW (Continuous Bag of Words) approach
   - Window size: ${windowSize} (context words on each side)
   - Generated ${trainingPairs.length} training pairs
...
if (process.argv[1] && process.argv[1].includes('clean-goals-script.js')) {
  cleanGoalsText();
}
